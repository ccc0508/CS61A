...
def boar_brawl(player_score, opponent_score):
    ...
    tenth_digit = opponent_score // 10 % 10
    sum = 3 * abs(ones_digit - tenth_digit)
    if sum >= 1:
        return sum
    else :
        return 1
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def always_roll_n(score,opppnent_score):
        return n
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    sus_point = sus_points(score + boar_point)
    if sus_point - score >= threshold:
        return 0
    else:
        return num_rolls  # Remove this line once implemented.
    # END PROBLEM 11
