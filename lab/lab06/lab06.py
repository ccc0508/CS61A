...
class Account:
    ...
    def deposit(self, amount):
        ...
        self.transactions += [Transaction(self.id,self.balance - amount,self.balance)]
        self.id += 1
        return self.balance
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.transactions += [Transaction(self.id,self.balance,self.balance)]
            self.id += 1
...
class ChangeMachine:
    ...
    def change(self, coin):
        ...
        if not result:
            return [coin]
        for b in result:
            self.coins = remove_one(self.coins,b)
